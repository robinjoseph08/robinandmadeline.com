...
- A **Placeholder Guest** carries **Placeholder Text**; naming the slot (during info collection or RSVP, until the deadline) never erases the descriptor, so the slot stays identifiable and re-nameable.
