...
info-collection flow, issue #9's public/personalized schedule, issue #10's
photo groups, issue #11's email compose-and-send flow, and issue #12's admin
dashboard and settings). Unit-level behavior stays in Go tests and vitest; e2e
